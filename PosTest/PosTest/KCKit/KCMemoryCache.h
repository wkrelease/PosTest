...
@interface KCMemoryCache : NSObject
 ...
 */
@property (copy) void(^didReceiveMemoryWarningBlock)(KCMemoryCache *cache);

/**
 A block to be executed when the app enter background.
 The default value is nil.
 */
@property (copy) void(^didEnterBackgroundBlock)(KCMemoryCache *cache);
