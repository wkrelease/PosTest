...
+ (KCFileHash *)hashForFile:(NSString *)filePath types:(KCFileHashType)types usingBlock:(void(^)(UInt64 totalSize, UInt64 processedSize, BOOL *stop))block {
    KCFileHash *hash = nil;
