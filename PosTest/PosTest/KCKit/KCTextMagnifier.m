...
@interface _KCTextMagnifierCaret : KCTextMagnifier {
    UIImageView *_contentView;
    UIImageView *_coverView;
}
@end

@implementation _KCTextMagnifierCaret
...
- (KCTextMagnifierType)type {
    return KCTextMagnifierTypeCaret;
}
...
@interface _KCTextMagnifierRanged : KCTextMagnifier {
    UIImageView *_contentView;
    UIImageView *_coverView;
}
@end

@implementation _KCTextMagnifierRanged
#define kMultiple 1.2
...
- (KCTextMagnifierType)type {
    return KCTextMagnifierTypeRanged;
}
...
@implementation KCTextMagnifier

+ (id)magnifierWithType:(KCTextMagnifierType)type {
    switch (type) {
        case KCTextMagnifierTypeCaret :return [_KCTextMagnifierCaret new];
        case KCTextMagnifierTypeRanged :return [_KCTextMagnifierRanged new];
    }
    return nil;
}
...
- (id)initWithFrame:(CGRect)frame {
    // class cluster
    if ([self isMemberOfClass:[KCTextMagnifier class]]) {
